...
PROTOBUF_NAMESPACE_OPEN
template<> ::del_contact_resp::DelContactResponse* Arena::CreateMaybeMessage<::del_contact_resp::DelContactResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace del_contact_resp {
...
class DelContactResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:del_contact_resp.DelContactResponse) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "del_contact_resp.DelContactResponse";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:del_contact_resp.DelContactResponse)
 private:
  class _Internal;
...
// .base_response.BaseResponse base_resp = 1;
inline bool DelContactResponse::_internal_has_base_resp() const {
  return this != internal_default_instance() && _impl_.base_resp_ != nullptr;
}
inline bool DelContactResponse::has_base_resp() const {
  return _internal_has_base_resp();
}
inline const ::base_response::BaseResponse& DelContactResponse::_internal_base_resp() const {
...
inline const ::base_response::BaseResponse& DelContactResponse::base_resp() const {
  // @@protoc_insertion_point(field_get:del_contact_resp.DelContactResponse.base_resp)
  return _internal_base_resp();
}
inline void DelContactResponse::unsafe_arena_set_allocated_base_resp(
    ::base_response::BaseResponse* base_resp) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:del_contact_resp.DelContactResponse.base_resp)
}
inline ::base_response::BaseResponse* DelContactResponse::release_base_resp() {
...
inline ::base_response::BaseResponse* DelContactResponse::unsafe_arena_release_base_resp() {
  // @@protoc_insertion_point(field_release:del_contact_resp.DelContactResponse.base_resp)
  
  ::base_response::BaseResponse* temp = _impl_.base_resp_;
  _impl_.base_resp_ = nullptr;
  return temp;
}
inline ::base_response::BaseResponse* DelContactResponse::_internal_mutable_base_resp() {
...
inline ::base_response::BaseResponse* DelContactResponse::mutable_base_resp() {
  ::base_response::BaseResponse* _msg = _internal_mutable_base_resp();
  // @@protoc_insertion_point(field_mutable:del_contact_resp.DelContactResponse.base_resp)
  return _msg;
}
inline void DelContactResponse::set_allocated_base_resp(::base_response::BaseResponse* base_resp) {
  ...
  _impl_.base_resp_ = base_resp;
  // @@protoc_insertion_point(field_set_allocated:del_contact_resp.DelContactResponse.base_resp)
}
...
inline const std::string& DelContactResponse::uid() const {
  // @@protoc_insertion_point(field_get:del_contact_resp.DelContactResponse.uid)
...
void DelContactResponse::set_uid(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.uid_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:del_contact_resp.DelContactResponse.uid)
}
inline std::string* DelContactResponse::mutable_uid() {
  std::string* _s = _internal_mutable_uid();
  // @@protoc_insertion_point(field_mutable:del_contact_resp.DelContactResponse.uid)
  return _s;
}
...
inline std::string* DelContactResponse::release_uid() {
  // @@protoc_insertion_point(field_release:del_contact_resp.DelContactResponse.uid)
...
inline void DelContactResponse::set_allocated_uid(std::string* uid) {
  ...
  // @@protoc_insertion_point(field_set_allocated:del_contact_resp.DelContactResponse.uid)
}
